...
var arrLang = {
  "en": {
    ...
    "BLOOM-TITLE": "Bloom Filter",
    "COLOR-TITLE": "Color Filter",
    "FILM-TITLE": "Film Filter",
    "FOG-TITLE": "Darkness Filter",
    "OLD-TITLE": "Old Filter",
  ...
  "es": {
    ...
    "BLOOM-TITLE": "Filtro de resplandor",
    "COLOR-TITLE": "Filtro de color",
    "FILM-TITLE": "Filtro de película",
    "FOG-TITLE": "Filtro de terror",
    "OLD-TITLE": "Filtro de antigüedad",
...
$(document).ready(function() {
  ...
  var y = document.getElementById("description-en");
  var x = document.getElementById("description-es");
  if(lang == null){
    lang = "en";
    $(".language-switch").prop('checked', false);
